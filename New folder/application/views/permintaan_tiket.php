                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="control-label col-lg-12">Expired Date</label>
                                                                <div class="col-lg-12">
                                                                    <input id="ed" type="date" value="<?php echo date('Y-m-d'); ?>" class="form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
    ...
    function addtotable() {
        ...
        cell4.innerHTML = $("#ed").val();
        cell5.innerHTML = aturan_pakai;
        cell6.innerHTML = $("#sel_anjuran").val();
        // cell6.style.display = "7";
        cell7.innerHTML = $("#sel_waktu").val();
        cell8.innerHTML = '<button type="button" style="width: 100%;" class="btn bg-danger btn-labeled legitRipple" onclick="hapus_obat(this)" id="btn_tambah"><b><i class="icon-trash"></i></b> Hapus</button>';
        cell9.innerHTML = $("#sel_obat").find(':selected').data('id');
        cell9.style.display = 'none';
        cell10.innerHTML = $("#sel_satuan").find(':selected').data('id');
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (i = 1; i < rowLength; i++) {
                    ...
                    var ed = oCells.item(4).innerHTML;
                    var aturan_pakai = oCells.item(5).innerHTML;
                    var anjuran = oCells.item(6).innerHTML;
                    var waktu = oCells.item(7).innerHTML;
                    var id_obat = oCells.item(9).innerHTML;
                    // console.log(id_permintaan, nama_obat, satuan, jumlah, ed, aturan_pakai, satuan, waktu);
                    insert_detail_permintaan(no_resep, id_permintaan, id_obat, nama_obat, satuan, jumlah, ed, aturan_pakai, anjuran, waktu, tanggal);
                }
    ...
    function insert_detail_permintaan(no_resep, id_permintaan, id_obat, nama_obat, satuan, jumlah, ed, aturan_pakai, anjuran, waktu, tanggal) {
