                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row" style="padding-top: 20px;">
                                        ...
                                        <div class="col-md-12">
                                            <form target="_blank" action="<?php echo base_url('cetak/detail_cetak'); ?>" method="post">
                                            <input type="hidden" name="id_permintaan" id="detail_idPermintaan">
                                            <div class="table-responsive">
                                                ...
                                                <input type="submit" class="btn btn-info" value="cetak detail"/>
                                            </div>
                                            </form>
                                        </div>
...
<script type="text/javascript">
    ...
    function get_riwayat(tgl_awal, tgl_akhir, norm) {
        $('#tabel_pasien').DataTable({
            ...
            "columns": [{
                ...
                {
                    "render": function(data, type, row) { // Tampilkan kolom aksi
                        var html = `<button onclick="deletepermintaan('`+row.id_permintaan+`')"  id="perawat" style="width:100%" class="btn btn-danger btn-xs">Delete</button>`;
                        return html;
                    }
                },
            ],
    ...
    function detailobat(id_permintaan,no_rekamedis,nama_pasien) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#detail_idPermintaan").val(id_permintaan);
                
                for (let index = 0; index < data.length; index++) {
                    html += `
                    <tr>
                    <td><input type="checkbox" name="id_detail[]" value="`+data[index].id+`"></td>
                    <td>` + (index+1)+ `</td>
    ...
    function deletepermintaan(id_permintaan) {
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url('master/delete_permintaan'); ?>",
            data: {
                'id_permintaan': id_permintaan,
            },
            success: function(data) {
