...
<body>
    <div class="myDivToPrint" id="myDivToPrint">
        ...
        <?php foreach ($cetak as $key) { ?>
            <div class="container" style="padding-top: 35px; font-weight: bold;">
                <div class="image">
            ...
            <div class="row" style="font-size: 8px;margin-top: 0px;font-weight: bold;">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="nilai_print">: <?php echo date('d/m/Y', strtotime($key->expired_date)); ?></div>
                </div>
                <div class="col-xs-12">
                ...
                <div class="col-xs-12" style="margin-top: -20px;height: 30px;margin-bottom: 10px;">
                    <center>
                        <div class="col-xs-12" style="font-size: 10px;"><b><?php echo strtoupper($key->waktu); ?></b></div>
                        <hr>
                    </center>
                </div>
                <?php
                ...
                if ($key->anjuran != "") {
                    $aturan = $key->anjuran;
                    echo '<div class="col-xs-12"><div class="jdl_print">ANJURAN</div><div class="nilai_print" style="font-size: 8px;">: ' . $aturan . '</div></div>';
                }
                ?>
            </div>
